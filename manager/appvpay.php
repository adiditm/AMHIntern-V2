...
$vCrit.=" and date(ftglentry) >= '$vAwal' and date(ftglentry) <= '$vAkhir'" ;


 
 $vsql="select distinct ftglentry, fidpenjualan,fidseller,fidmember, fketerangan,fjumlah, fsubtotal    from tb_payment_temp where fjenis='POIN' ";
 $vsql.= " union ";
 $vsql.= " select distinct ftglentry, fidpenjualan,fidseller,fidmember, fketerangan ,fjumlah, fsubtotal  from tb_payment where   fjenis='POIN' and fmethod='ctr' ";

  $vsql.=$vCrit;
 $vsql.=" order by ftglentry ";
 $db->query($vsql);
 $db->next_record();
...
<div class="right_col" role="main">
		<div><label>
		<h3>  Approval Pembayaran</h3></label></div>
    ...
    <div class="table-responsive">
        <table width="90%" border="0" class="table table-striped">
          <tr >
            ...
            <td width="10%" style="height: 24px"><div align="center"><strong>Date</strong></div></td>
            <td class="" width="15%" style="height: 24px" align="center"><strong>ID Payment</strong></td>
            <td class="" width="15%" style="height: 24px"><strong>Operator Pembayaran</strong></td>
            <td width="10%" align="center" style="height: 24px"><strong>ID Jamaah </strong></td>
            <td align="center" style="width: 19%; height: 24px;"><strong>Name</strong></td>
            <td width="12%" align="center" style="height: 24px"><strong>Note</strong></td>
            <td width="14%" align="center" style="height: 24px"><strong>Jml. Pembayaran </strong></td>
          ...
          <? 
			 ...
			 $vsql ="select distinct ftglentry, fidpenjualan,fidseller,fidmember, fketerangan,fprocessed, fjumlah, fsubtotal   from tb_payment_temp where   fjenis='POIN' and fmethod='ctr' ";
			 $vsql.= " union ";			 
			 $vsql.= " select distinct ftglentry, fidpenjualan,fidseller,fidmember, fketerangan,fprocessed , fjumlah, fsubtotal  from tb_payment where   fjenis='POIN' and fmethod='ctr' ";
