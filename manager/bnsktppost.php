...
<div class="right_col" role="main">
		<div><label>
		<h3> Report Diskon KTP</h3></label></div>
    ...
    <div class="table-responsive">
        <table  width="100%" border="0" class="table table-striped table-bordered" id="tblMain">
          ...
          <tr style="font-weight:bold">
            ...
            <td width="15%" align="center" style="height: 24px" class="hide"><strong> Status Sync</strong></td>
          ...
          <tr id="tr<?=$vIdSys?>">
            ...
            <td id="tdstatpay<?=$vIdSys?>" class="hide"><?=$vSPayText?></td>
            <td id="tdstatbutt<?=$vIdSys?>" class="hide"><input  id="btnPay<?=$vIdSys?>" name="btnPay<?=$vIdSys?>" type="button" class="btn btn-info btn-xs" value="Tandai Terbayar" onClick="setPay('<?=$vIdSys?>','<?=$vRemark?>')" <? if ($vStatPay=='1') echo 'disabled'; ?>></td>
            </tr>
           <? } ?>
          <tr class="hide">
            <td style="width: 5%" >&nbsp;</td>
