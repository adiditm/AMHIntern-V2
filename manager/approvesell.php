...
<br />
   ...
   for ($i=0;$i<$vPageCount;$i++) {
     $vPageUrl="approvesell.php?uPage=".$i."&uAwal=".$oPhpdate->DMY2YMD($oPhpdate->YMD2DMY($vAwal,"-"),"-")."&uAkhir=".$oPhpdate->DMY2YMD($oPhpdate->YMD2DMY($vAkhir,"-"),"-")."&current=mdm_admin&menu=mdm_trans_appvprod";
?>
