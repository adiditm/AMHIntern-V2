...
if ($_GET['lmKorwil'] !='')
   $vCrit .= " and fidregistrar='{$_GET['lmKorwil']}' ";
...
*/
	...
	<div class="right_col" role="main">
		...
		<div><label>
		<h3> Jamaah Terdaftar 
		  <? if($_GET['lmKorwil'] !='') echo "oleh {$_GET['lmKorwil']}"?></h3>
		</label></div>
...
<tr >
              <td style="width: 14%; height: 25px;" nowrap><div align="left">Korwil Pendaftar</div></td>
              <td style="height: 25px"><div align="left">
            ...
            <tr>
              ...
              <td colspan="2"><div align="left"><br>
                ...
                <input name="Submit2" type="button" class="btn btn-default" value="Reset" onClick="document.location.href='../manager/rpt_regkorsub.php?op=&current=mdm_admin&menu=mdm_admin_lapregkor'" />
...
<select class="form-control" style="width:80px;display:inline-block;" onchange="if(this.value) window.location.href=this.value;">
   ...
   for ($i=0;$i<$vPageCount;$i++) {
	   $idisp=$i;
	 if ($vOP=="post") $idisp=0;
     $vPageUrl="rpt_regkorsub.php?lmAktif=".$vAktif."&lmMship=".$vPrem."&uPage=".$idisp."&lmSort=".$vSort."&current=".$_REQUEST['current']."&menu=".$_REQUEST['menu'];
?>
