...
if($_POST['lmKorwil'] !='') 
 ...
 $vsql="select a.*, b.fnama from tb_komisi a left join m_korwil b on a.fidkorwil=b.fidkorwil where a.fkind='REG'  ";
...
; 
 $('#lmKorwil').select2();
        ...
        buttons: [{
             					extend: 'excelHtml5',
								filename: 'BonusReg<?="$vPeriodOri"?>',
								title: 'Bonus Registrasi Periode <?="$vPeriodOri"?>'
						}	, 
			 				{ 
								extend: 'print',
								title: 'Bonus Registrasi Periode <?="$vPeriodOri"?>',
...
<div class="right_col" role="main">
		<div><label>
		<h3>Report Diskon Registrasi </h3>
		</label></div>
        ...
        <div class="row"> 
           ...
           <b>  Periode </b>  </div>
              <div class="col-lg-4">
               ...
               <?
               		 $vSQL="select distinct concat(a.fdfrom,'_',a.fdto) as fperiod, fdfrom, fdto from tb_komisi a  where a.fkind='REG'  ";
					$dbin->query($vSQL);
...
<div class="row"> 
               <div class="col-lg-2">
           <b>   Korwil / Subkorwil Pendaftar </b>  </div>
               <div class="col-lg-4">
    ...
    <div class="table-responsive">
        ...
        <thead>
          <tr style="font-weight:bold">
            ...
            <td width="14%" align="center" style="height: 24px"><strong>Jml. Diskon (netto)</strong></td>
          ...
          <tr id="tr<?=$vIdSys?>">
            ...
            <td id="tdstat<?=$vIdSys?>" class="hide"><input  id="btnPay<?=$vIdSys?>" name="btnPay<?=$vIdSys?>" type="button" class="btn btn-info btn-xs" value="Tandai Terbayar" onClick="setPay('<?=$vIdSys?>','<?=$vRemark?>')" <? if ($vStatPay=='1') echo 'disabled'; ?>></td>
            </tr>
           <? } ?>
          <tr class="hide">
            <td style="width: 5%" >&nbsp;</td>
