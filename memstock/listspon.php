...
$vsql="select * from m_anggota where 1 and frefer ='{$_SESSION['LoginUser']}' ";
...
*/
	...
	<div class="right_col" role="main">
	  ...
	  <?=$_SESSION['LoginUser']?></h3></label></div>
...
?>
    ...
    <table width="100%" border="0" align="left" cellpadding="1" cellspacing="0" class="table" style="background-color:white" >
      ...
      <tr style="color:;font-weight:bold"> 
        ...
        <td width="268">Tanggal Approve</td>
        <td width="268">Tanggal Berangakat</td>
        ...
        <td width="150" class=""><div align="center">Program</div></td>
         <td width="150" class="" align="center">Status</td>
		 ...
		 if ($vAktifList=='1')
			 ...
			 $vActiveText = "Tidak Aktif";
			  ...
			  $vTglAktif=$oPhpdate->DMY2YMD($oPhpdate->YMD2DMY($db->f('ftglaktif')));
				 ...
				 $vSQL ="select fnama from m_program where fidprogram='$vProgID'";
				 $db1->query($vSQL);
				 $db1->next_record();
				 $vProg=$db1->f('fnama');
      ...
      <tr  bgcolor="<?=$vActives?>" style="<?=$vStockistCSSs?>"  id="tr<?=$vIDSys?>"  > 
        ...
        <td  style="height: 39px" nowrap> 
          
       
            
            <?=$oPhpdate->YMD2DMY($db->f('ftgldaftar'))?>
            
            
            
          </td>
        <td  style="height: 39px" nowrap><?=$oPhpdate->YMD2DMY($db->f('ftglaktif'))?></td>
        <td  style="height: 39px"><?=$oPhpdate->YMD2DMY($db->f('ftgldepart'))?></td>
        ...
        <td class="" style="height: 39px;<? if ($db->f('fpriv')=='1') echo 'background-color:#ccc';?>" nowrap ><div align="left">
         ...
         <td class=""  style="height: 39px;<? if ($db->f('fpriv')=='1') echo 'background-color:#ccc';?>"><div align="left">

          <?=$vProg?>

        </div></td>
        <td class=""  style="height: 39px;<? if ($db->f('fpriv')=='1') echo 'background-color:#ccc';?>"><?=$vActiveText?></td>
