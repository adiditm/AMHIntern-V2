<?php include_once("../framework/outer_headside.blade.php")?>
   ...
   if ($_POST['hPost'] != '1') {
	...
	/*		$vNom = 0;
			...
			if ($fangsur1 > 0) {
				   ...
				   $oKomisi->insertPayment($fidmember,$fidmember,date("Y-m-d H:i:s"),$vDesc,$fangsur1,0,$vNom,'fangssur1') ;
			}
			...
			if ($fairporttax > 0) {
				   $vDesc = "Handle";
				   $oKomisi->insertPayment($fidmember,$fidmember,date("Y-m-d H:i:s"),$vDesc,$fairporttax,0,$fairporttax,'handle') ;
			}
			
			
			if ($fassure > 0) {
				   $vDesc = "Asuransi";
				   $oKomisi->insertPayment($fidmember,$fidmember,date("Y-m-d H:i:s"),$vDesc,$fassure,0,$fassure,'assure') ;
			}


			if ($farabassure > 0) {
				   $vDesc = "Asuransi Saudi Arabia";
				   $oKomisi->insertPayment($fidmember,$fidmember,date("Y-m-d H:i:s"),$vDesc,$farabassure,0,$farabassure,'arabassure') ;
			}
...
<div class="divtr col-lg-12" style="display:none" id="divSeat">
                                  <label id="lblSeat" for="exampleInputEmail1" style="color:#00f"><span id="spDesc"></span><br>Keberangkatan: <span id="spDepart"></span>, <span id="spPlane"></span>, Sisa seat: <span id="spSisa">0</span><span id="spHotel"></span> </label>
